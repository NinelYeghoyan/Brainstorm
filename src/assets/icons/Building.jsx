const IconBuilding = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="17" height="15" fill="currentColor" viewBox="0 0 17 15">
        <path d="M8.333 3.333V0H0v15h16.667V3.333H8.333zm-5 10H1.667v-1.666h1.666v1.666zm0-3.333H1.667V8.333h1.666V10zm0-3.333H1.667V5h1.666v1.667zm0-3.334H1.667V1.667h1.666v1.666zm3.334 10H5v-1.666h1.667v1.666zm0-3.333H5V8.333h1.667V10zm0-3.333H5V5h1.667v1.667zm0-3.334H5V1.667h1.667v1.666zm8.333 10H8.333v-1.666H10V10H8.333V8.333H10V6.667H8.333V5H15v8.333zm-1.667-6.666h-1.666v1.666h1.666V6.667zm0 3.333h-1.666v1.667h1.666V10z" />
    </svg>
);
